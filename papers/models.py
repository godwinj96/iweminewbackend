...
class Papers(models.Model):
    ...
    cover_page = models.ImageField(upload_to=f"uploads/papers/{name}/cover", null=True, blank=True)
    ...
    file = models.FileField(upload_to=f"uploads/papers/{name}", null=True, blank=True)
